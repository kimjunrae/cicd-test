...
public class LogConfig {
    ...
    @Around("within(com.example.doosan.demo.controller.ResponseTimeCodeController))") // ex. within(me.shinsunyoung.demo..*)) 1
    public Object logging(ProceedingJoinPoint pjp) throws Throwable { // 2
        ...
        log.info("-----------> ResponseTime : {} ({}ms)",  pjp.getSignature().getName(), endAt - startAt);
